...
##Original code by @sloria, with slight modifications by myself and others
...
document2 = unicode("""Python, from the Greek word (πύθων/πύθωνας), is a genus of
nonvenomous pythons[2] found in Africa and Asia. Currently, 7 species are
recognised.[2] A member of this genus, P. reticulatus, is among the longest
snakes known.""", "utf-8")
document2 = tb(document2)
